...
const routes = [
  { path: '/login', component: () => import('../views/auth/Login.vue') },
  {
    ...
    children: [
      ...
      { path: 'purchase', name: 'Purchase', component: () => import('../views/purchase/Purchase.vue'), meta: { title: '采购入库' } },
      { path: 'issue', name: 'Issue', component: () => import('../views/issue/Issue.vue'), meta: { title: '领用出库' } },
      ...
      { path: 'settings/users', name: 'Users', component: () => import('../views/settings/Users.vue'), meta: { title: '人员管理' } },
